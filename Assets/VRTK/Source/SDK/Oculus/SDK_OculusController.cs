...
//MEG            //if ((connectedControllers & OVRInput.Controller.Touchpad) == OVRInput.Controller.Touchpad)
            if ((connectedControllers & OVRInput.Controller.Touch) == OVRInput.Controller.Touch)
                {
                    return ControllerType.Oculus_GearVRHMD;
            }

//MEG            //if ((connectedControllers & (OVRInput.Controller.LTrackedRemote | OVRInput.Controller.RTrackedRemote)) != 0)
